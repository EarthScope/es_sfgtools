...
if __name__ == "__main__":
    ...
    test = dh.catalog.delete_entries(
        network=network,
        station=station,
        campaign=campaign,
        type="novatel000",
        where="local_path = '/Users/franklyndunbar/Project/SeaFloorGeodesy/Data/Cascadia2023/NCL1/HR/329653_001_20230624_153925_00281_NOV000.bin' ",
    )
    print(test)
