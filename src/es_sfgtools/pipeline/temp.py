...
class DataHandler:
    ...
    def _process_targeted(
        ...
        match process_func:
            ...
            case proc_funcs.nov770_to_rinex:
                process_func_p = partial(
                    process_func,site=parent.station,year=parent.timestamp.year,show_details=show_details
                )
    ...
    def process_acoustic_data(self, network: str, station: str, survey: str,override:bool=False, show_details:bool=True,update_timestamp:bool=False):
    ...
    def process_imu_data(self, network: str, station: str, survey: str,override:bool=False, show_details:bool=True,update_timestamp:bool=False):
    ...
    def process_rinex(self, network: str, station: str, survey: str,override:bool=False, show_details:bool=True,update_timestamp:bool=False):
    ...
    def process_gnss_data_kin(self, network: str, station: str, survey: str,override:bool=False, show_details:bool=True,update_timestamp:bool=False):
    ...
    def process_gnss_data(self, network: str, station: str, survey: str,override:bool=False, show_details:bool=True,update_timestamp:bool=False):
    ...
    def process_campaign_data(
        self, network: str, station: str, survey: str, override: bool = False, show_details: bool=True,update_timestamp:bool=False
    ):
        """
